...
import com.javifast.clase_x_base_datos.Clase_49_conexion;
import com.javifast.clase_x_archivos.Clase_45_file;
import com.javifast.clase_v_basicas.Clase_03_a_08_introductoria;
import com.javifast.clase_v_conocimiento_POO.Clase_24_intro;
import com.javifast.clase_v_ejemplo_aplicacion.Clase_34;
import com.javifast.clase_v_intermedia.Clase_35_StringBuilder;
...
public class Clase_salidas {
    ...
    public static void main(String... javifast) throws Exception { // aqui se invoca los metodos y clases con el parametro correspondiente
        ...
        //c3.tipos_datos(); //Clase 5 a 6
        //c3.conver_datos(); //Clase 7
        //c3.tipo_String(); //Clase 8
        //-------------------------------Clase 9  Sentencia if ------------------------------------------------------------------------------
        //Clase_09_sentencias c9 = new Clase_09_sentencias(10); // aqui colocamos el numero en este caso el 5 podemos cambiarlo por otro para
        // probar los distintos resultados  
        ...
        //c11.ciclo_for(4); //Clase 12 for
        //c11.ciclo_dowhile(5); //Clase 13 Do while
        //-------------------------------Clase 14 a 17  Vector ------------------------------------------------------------------------------
        //Clase_14_a_17_vector c14 = new Clase_14_a_17_vector();
        //c14.vector_inicial(); //Clase 14
        //c14.vector_paralelo(); //Clase 15
        //c14.vector_mayor_menor(); //Clase 16
        //c14.vector_orden_burbuja(); //Clase 17
        //-------------------------------Clase 18 a 19  Matrices ----------------------------------------------------------------------------
        //Clase_18_a_19_matrices c18 = new Clase_18_a_19_matrices();
        //c18.matriz(); //Clase 18
        //c18.operacion_matrices(800,1300); //Clase 19 nota: el valor 800 y valor 1300 son los tiempo de espera en milisegundos
        ...
        //-------------------------------Clase 20 Switch  -----------------------------------------------------------------------------------
        //Clase_20_switch c20 = new Clase_20_switch(); //Clase 20
        //-------------------------------Clase 21 y 22  Clases y metodos -----------------------------------------------------------------------------------
        //Clase_21_y_22_clasesyMetodos c21 = new Clase_21_y_22_clasesyMetodos(); // llamado de la clase por defecto // Clase 21
        //c21.saludar(); //llamado del metodo //Clase 22
        //-------------------------------Clase 23  Alcance de las variables -----------------------------------------------------------------        
        //Clase_23_alcanze_variables c23 = new Clase_23_alcanze_variables(); // muestra la variable global pero no puede mostrar la local ya que esta dentro de un metodo aislado
        ...
        Clase_24_intro c24 = new Clase_24_intro("LG", "NEGRO"); //se crea un constructor en base la clase Clase_24_intro asignandole los valores del metodo Clase_24_intro
        ...
        //cl24.llamarespecial(c); //se llama al metodo llamada especial el cual toma los atributos del constructor c creado
        ...
        //cl25.saludo(); // se llama al metodo saludo en clase_25 con el parametro "javier" como el segundo parametro no es definido por defecto se le asigna "null"
        ...
        //Clase_28_Herencia cl28 = new Clase_28_Herencia("Elefante","mani",25); // en este caso solo tenemos acceso a la clase propia sin poder acceder a los metodos de la clase hija
        //cl28.setNombre("elefante");
        //cl28.setEdad(25);
        //-------------------------------Clase 29 Polimorfismo ------------------------------------------------------------------------
        //Clase_29_polimorfismo c_hijo_29 = new Clase_29_hijo("Pastor Aleman","pipe","dogShow",4); //para utilizar el polimorfismo se debe instanciar la clase padre
        // dentro de la clase hijo
        //c_hijo_29.alimentarse();
        //Clase_29_polimorfismo c_hija_29 = new Clase_29_hija();
        //c_hija_29.alimentarse();
        //-------------------------------Clase 30 Encapsulamiento ------------------------------------------------------------------------
        //Clase_30 c30 = new Clase_30(); // ejemplo de metodo split en string en un array
        ...
        Clase_34 c34 = new Clase_34(); // en paquete Ejemplo_Aplicativo1
        //c34.aplicacion1();
        ...
        /*Clase_52_DAO_conexion c52 = new Clase_52_DAO_conexion();
           Clase_49_a_51_getset db51 =  new Clase_49_a_51_getset();
           db51.setId(9);
           ...
           try{
            ...
            //dao52.borrar(db51);
            for(Clase_49_a_51_getset db : dao52.listar() ){
